...
(Piper, `TTS_PROVIDER=piper_api`). O
...
diretamente. Isso é só do laboratório; a voz das aulas é o Piper.
...
conservadoramente, `supports_voice=False` para os modelos da lista) —
