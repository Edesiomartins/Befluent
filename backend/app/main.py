...
from app.api import assessments,auth,conversations,dashboard,grammar,language_profiles,languages,learning_plans,lessons,levels,listening,onboarding,placement_tests,profile,progress,pronunciation,reviews,settings,speech,study_sessions,vocabulary,writing
...
for router in [auth.router,profile.router,languages.router,levels.router,onboarding.router,dashboard.router,placement_tests.router,language_profiles.router,assessments.router,learning_plans.router,lessons.router,study_sessions.router,conversations.router,speech.router,vocabulary.router,reviews.router,grammar.router,listening.router,pronunciation.router,writing.router,progress.router,settings.router]:
