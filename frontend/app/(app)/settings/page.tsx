...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl">
      <p className="text-sm font-semibold text-primary">Preferências</p><h1 className="mt-2 page-title">Configurações</h1><p className="mt-3 leading-7 text-text-secondary">Ajuste como o Fluentia apresenta áudio, traduções e correções.</p>
